...
class BlockController extends AbstractController
{
    ...
    public function block(
        ...
        if ($blocker->getId() === $blocked->getId()) {
            return new JsonResponse(['data' => null, 'error' => 'Cannot block yourself'], 400);
        }
        ...
        if ($existing) {
            return new JsonResponse(['data' => ['message' => 'Already blocked'], 'error' => null]);
        }
        ...
        return new JsonResponse(['data' => ['message' => 'User blocked'], 'error' => null], 201);
    }
    ...
    public function unblock(
        ...
        if (!$block) {
            return new JsonResponse(['data' => null, 'error' => 'Block not found'], 404);
        }

        $em->remove($block);
        $em->flush();

        return new JsonResponse(['data' => ['message' => 'User unblocked'], 'error' => null]);
    }
    ...
    public function getBlocked(
        ...
        return new JsonResponse(['data' => ['blocked_users' => $blocked], 'error' => null]);
    }}