...
class FriendshipController extends AbstractController
{
    ...
    public function solicitar(
        ...
        if ($sender->getId() === $receiver->getId()) {
            return new JsonResponse(['data' => null, 'error' => 'Cannot send request to yourself'], 400);
        }
        ...
        if ($existing) {
            return new JsonResponse(['data' => null, 'error' => 'Request already pending'], 400);
        }
    ...
    public function aceptar(
        ...
        if (!$data || !isset($data['request_id'])) {
            return new JsonResponse(['data' => null, 'error' => 'request_id required'], 400);
        }
        ...
        if (!$friendRequest) {
            return new JsonResponse(['data' => null, 'error' => 'Request not found'], 404);
        }
